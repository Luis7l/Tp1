# el archivo gitignore es utilizado en proyectos que usan git.Su funcion principal es ignorar archivos y carpetas especificas para evitar que sean a�adidas al repositorio 
